          ...
          <section className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="relative mx-auto w-64 sm:w-72 lg:w-80">
                <div className="absolute -bottom-6 left-6 bg-white/95 border border-[#BEE9E8] rounded-full px-4 py-2 text-xs font-semibold text-[#0E79B2] shadow-lg">
                  Free bonus inside
                </div>
              </div>
            </div>
          ...
          <section className="mt-16 lg:mt-20">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl sm:text-2xl font-bold text-[#1F2937]">
                Why families keep reading
              </h2>
              <span className="text-xs text-slate-500 uppercase tracking-widest">
                Real notes, real relief
              </span>
            </div>
