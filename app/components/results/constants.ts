...
export const RESULTS_REVIEW_CTA_LABEL = "Leave a Review";
...
export const RESULTS_CALL_CTA_IMAGE_SRC = "/assets/img/Book%20A%20Call/troy-book-a-call.png";
export const RESULTS_CALL_CTA_IMAGE_ALT = "Troy, home security specialist";
