...
export default function HomePage({
  ...
  const bonusEndsAt = useSyncExternalStore(
        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16 items-center relative z-10">
          ...
          >
            ...
            <p className="text-slate-600 text-base sm:text-lg lg:text-xl leading-relaxed mb-3 sm:mb-4 lg:mb-5 max-w-xl">
              In 60 seconds, get a <strong>FREE home security plan</strong> so
              you know your family is safe, even when you’re away. Designed for
              Filipino homes: check on your kids, your entrance, or your whole
              house without sacrificing comfort.
            </p>
            <p className="text-slate-500 text-sm sm:text-base lg:text-base italic leading-relaxed mb-6 sm:mb-8 lg:mb-10 max-w-xl">
              If your plan doesn’t fit your home, message or call us within 7
              days and we’ll revise it for free until it’s clear and practical
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
                ...
                <span className="text-[#63B3ED] italic">Smart</span> Home,{" "}
                <br />
                Without the Hassle
              </h2>
              <div className="space-y-6 text-slate-300 text-lg leading-relaxed font-light">
                <p>
                  You lie in bed at night running through the checklist.
                  You&apos;ve looked into smart home security, but it&apos;s a
                  dizzying maze of confusing gadgets.
                </p>
                <div className="pl-6 border-l-4 border-[#0E79B2] my-8">
                  <p className="text-white text-xl italic font-serif">
                    &quot;You’re trusting us with your home and your peace of
                    mind and I take that personally.&quot;
                  </p>
                </div>
                <p>
                  Hi I’m <strong>Troy</strong>, founder of Safely Secured Homes.
                  Growing up, my parents were often away for work, and as the
                  eldest I looked after my younger brother. That responsibility
                  shaped my mission: make home safety simple, reliable, and
                  stress-free.
                </p>
                <div className="pl-6 border-l-4 border-[#0E79B2] my-8">
                  <p className="text-white text-xl italic font-serif">
                    &quot;So let me personally help you secure what matters
                    most.&quot;
                  </p>
                </div>
                <p>
                  Because every family deserves to feel safe and in control of
                  their home. My team and I are ready to do the same for you.
                  We’ve helped families and business owners sleep better at
                  night and we’re dedicated to your complete satisfaction.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <h3 className="font-bold text-xl mb-3 text-[#2D3748]">
                  {item.title}
                </h3>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="group cursor-default">
                ...
                <h3 className="font-bold text-2xl mb-4 text-[#2D3748]">
                  {step.title}
                </h3>
      ...
      <div className="grid lg:grid-cols-2">
          ...
          <div className="space-y-4">
            {[
              ...
              <ReasonItem
                ...
                onClick={() =>
                  setExpandedReason(expandedReason === i ? null : i)
                }
              />
            ))}
          </div>
        ...
        <section className="py-24 px-6 lg:px-20 bg-[#F7FAFC]">
          <h2 className="text-3xl font-bold mb-4 text-[#2D3748]">
            What we{" "}
            <span className="text-[#0E79B2] underline decoration-4">
              provide
            </span>
          </h2>
          <p className="text-slate-600 mb-12 text-lg">
            We provide the complete integrated system. From home security to
            smart home, we deliver a seamless experience.
          </p>
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              >
                ...
                <h4 className="font-bold text-[#2D3748] text-lg mb-2">
                  {feat.title}
                </h4>
        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-4">
            <AccordionItem title="Is it safe? I don't want people watching my kids.">
              ...
              meaning your footage stays in your house, not on a random server
              abroad. We also provide physical privacy shutters for indoor
              cameras for 100% certainty.
            </AccordionItem>
            <AccordionItem title="This seems expensive. I can probably find cheaper cameras online.">
              That's a common concern, and it's true, you can find standalone
              devices. But you're not just buying a camera, you're investing in
              your safety and security. We provide free consultation and site
              visits to really tailor-fit your needs. Plus our service doesn't
              end there, we provide support for your inquiries because we
              believe that a happy client is a long-time partner. A cheap camera
              that fails or is too complicated to use costs you more eventually.
              We guarantee your peace of mind is worth it.
            </AccordionItem>
            <AccordionItem title="This looks complicated to set up and use.">
              This is exactly why families choose us. You don't need to be
              "techy". We handle the entire technical side. Our experts will
              install everything, set up the app on your phone, and personally
              train you and your family until you're comfortable. We provide
              simple, step-by-step guides. In fact, our goal is to make it so
              simple that your lola or your kids can check the cameras. We make
              advanced technology feel effortless.
            </AccordionItem>
            <AccordionItem title="What happens after you install it? If something breaks, am I on my own?">
              This is where we are completely different. Our relationship starts
              after the installation. You get 1 year of warranty support via
              call, chat, or video. For ultimate peace of mind, you can add Home
              Protect Plus, which is like health insurance for your security
              system. Covering repairs and giving you priority support. We don't
              believe in 'sell and forget.' We protect your home for the long
              term.
            </AccordionItem>
            <AccordionItem title="I'm in a small apartment. Do I really need a security system?">
              Security isn't about the size of your home. It's about the safety
              of your family. This is why we created our affordable,
              pre-designed bundles. Our 'Family of Four Fun-Sized Home
              Protection' bundle, for example, is specifically made for homes
              like yours. It covers the essential entry points without
              overcomplicating things or breaking the bank. Let's start with
              securing what matters most.
            </AccordionItem>
            <AccordionItem title="I can probably install it myself and save the installation fee.">
              You certainly could try, but consider the hidden costs. The hours
              of your time, the frustration of troubleshooting, potential Wi-Fi
              issues, and the risk of incorrect placement leaving critical blind
              spots. Our professional installation ensures optimal camera
              angles, secure and hidden wiring, and seamless integration of all
              devices from day one. We make it work perfectly the first time, so
              you can be confident your system is active and protecting your
              family.
            </AccordionItem>
            <AccordionItem title="How do I know your equipment is reliable and won't break down in a year?">
              We only use industry standard equipment built to withstand
              Philippine weather. Rain or Shine, it will be there. But more
              importantly, our guarantee isn't just on the device. It's on the
              entire system working together. With our yearly device health
              check service (included in some bundles or available as an
              upsell), we proactively ensure everything is running smoothly.
              We're not just a service provider, we're your long-term safety
              partner.
            </AccordionItem>
            <AccordionItem title="I need to think about it / discuss it with my family">
              We understand completely. Security is a family decision. However,
              while you're discussing, our limited installation slots for the
              upcoming weekend are filling up, and the stock of freebies (like
              the smoke detectors and first aid kits) is low. Why not take the
              first step at no cost? Let us provide you with a free personalized
              consultation. This will give your family all the concrete details,
              pricing, and a professional plan to discuss, making the decision
              much easier. Secure your free consultation now, and you'll have
              all the information you need in a minute.
            </AccordionItem>
          </div>
        </div>
      </section>
