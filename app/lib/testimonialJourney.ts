export const TESTIMONIAL_JOURNEY_ENTRY_PATH = "/rate";
export const TESTIMONIAL_JOURNEY_SUCCESS_REDIRECT_PATH =
  "/schedule-call?source=review";

export const TESTIMONIAL_JOURNEY_REVIEW_CTA_LABEL =
  "Leave a review and get a home safety consultation";
export const TESTIMONIAL_JOURNEY_REVIEW_CTA_SUPPORT_TEXT =
